...
public class OrderController {
    ...
    public String orders(Model model, String status, String search, Integer pageNo, Integer pageSize){   	
		...
		/*
		 * if (orderStatus == OrderStatus.PROCESSING) { List<User> shippers =
		 * userService.getAllShippers(); // Replace with your actual method
	...
	public String update(@PathVariable("id") Long id, @PathVariable("newStatus") String newStatus, RedirectAttributes attributes) {
		...
		return "redirect:/admin/orders?status=" + newOrderStatus.name();
	}
