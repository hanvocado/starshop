        ...
        <div class="row">
          ...
          <!-- Header -->
              ...
              <div class="card-body">
                  ...
                  <div class="col-md-8 col-lg-7">
                    <dl class="row text-sm-right">
                      ...
                      <dd class="col-sm-9">${order.user.getFullName() }</dd>
                      <dt class="col-sm-3">Địa chỉ:</dt>
                      <dd class="col-sm-9">${address.toString() }</dd>
                      <dt class="col-sm-3">SĐT:</dt>
                      <dd class="col-sm-9">${order.user.phoneNumber }</dd>
                    </dl>
                    <!-- End Row -->
                  </div>
                </div>
            ...
            <div class="card mb-3 mb-lg-5">
              <!-- Header -->
              <div class="card-header">
                <h4 class="card-header-title">Đơn: #<span>${order.id }</span></h4>
              </div>
              <!-- End Header -->
