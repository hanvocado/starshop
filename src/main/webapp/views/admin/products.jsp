	                ...
	                <tr>
	                  ...
	                  <td>
						...
						<td>
					       ...
					       <a class="btn btn-soft-warning btn-xs" data-toggle="modal" data-target="#productModal" onclick="editCategory(${product.id}, '${product.name}', ${product.isPublished()})">
        ...
        <div class="modal fade" id="productModal" tabindex="-1" role="dialog" aria-labelledby="inviteUserModalTitle" aria-hidden="true">
	        <div class="modal-dialog modal-dialog-centered" role="document">
	            <div class="modal-content">
	                ...
	                <form id="productForm" action="<c:url value="/admin/add-product"/>" method="post">
